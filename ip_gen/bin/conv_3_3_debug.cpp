...
_conv_stencil(0, hw_output_s0_x_xi, hw_output_s0_y_yi) = 0;
   // produce conv.stencil
   uint16_t _259 = (uint16_t)(0);
   _conv_stencil(_hw_output_s0_x_xi, _hw_output_s0_y_yi) = _259;
   ...
   uint16_t _315 = _conv_stencil(_hw_output_s0_x_xi, _hw_output_s0_y_yi);
   ...
   int32_t _333 = _hw_output_s0_y_yi + 2;
   uint16_t _334 = _hw_input_global_wrapper_stencil(_hw_output_s0_x_xi, _333);
   ...
   _conv_stencil(_hw_output_s0_x_xi, _hw_output_s0_y_yi) = _351;
   // consume conv.stencil
   uint16_t _352 = _conv_stencil(_hw_output_s0_x_xi, _hw_output_s0_y_yi);
