...
int conv_3_3_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
...
_255;
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"conv_3_3"}, 1};
  ...
  int32_t _353 = _halide_buffer_get_min(_output_buffer, 1);
  bool _354 = 0 <= _353;
  int32_t _355 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _356 = _355 + _353;
  bool _357 = _356 <= 62;
  bool _358 = _354 && _357;
  if (!_358)   {
   int32_t _359 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _360 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _361 = _360 + _359;
   int32_t _362 = _361 + -1;
   int32_t _363 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 61, _359, _362);
   return _363;
  }
  int32_t _364 = _halide_buffer_get_min(_output_buffer, 0);
  bool _365 = 0 <= _364;
  int32_t _366 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _367 = _366 + _364;
  bool _368 = _367 <= 62;
  bool _369 = _365 && _368;
  if (!_369)   {
   int32_t _370 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _371 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _372 = _371 + _370;
   int32_t _373 = _372 + -1;
   int32_t _374 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 61, _370, _373);
   return _374;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 62; _output_s0_y++)
  {
   ...
   {
    int32_t _375 = _output_s0_y * 62;
    int32_t _376 = _375 + _output_s0_x;
_376;
    uint16_t *_hw_output_stencil_host = (uint16_t *) _hw_output_stencil->host_ptr;
    uint16_t _377 = _hw_output_stencil_host[_376];
    uint8_t _378 = (uint8_t)(_377);
    int32_t _379 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _380 = _379 * _output_s0_y;
    int32_t _381 = _380 + _output_s0_x;
    ((uint8_t *)_output)[_381] = _378;
   } // for _output_s0_x
  } // for _output_s0_y
