...
// ==============================================================
#ifndef __unoptimized_conv_cud__HH__
#define __unoptimized_conv_cud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(unoptimized_conv_cud) {
    ...
    SC_CTOR(unoptimized_conv_cud):  simcore_mac_0_U ("simcore_mac_0_U") {
