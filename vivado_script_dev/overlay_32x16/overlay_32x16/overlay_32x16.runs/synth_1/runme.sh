...
HD_PWD='/home/charles/tmp/vivado_script_dev/overlay_32x16/overlay_32x16/overlay_32x16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log overlay_32x16_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source overlay_32x16_wrapper.tcl
