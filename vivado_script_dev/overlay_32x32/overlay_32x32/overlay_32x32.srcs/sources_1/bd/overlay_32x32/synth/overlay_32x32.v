...
//Date        : Fri Aug 14 16:09:38 2020
//Host        : charles-XPS-13-9370 running 64-bit Ubuntu 18.04.5 LTS
//Command     : generate_target overlay_32x32.bd
//Design      : overlay_32x32
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "overlay_32x32,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=overlay_32x32,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_zynq_ultra_ps_e_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "overlay_32x32.hwdef" *) 
module overlay_32x32
   ();

  wire [31:0]addone_32x32_0_arg_0_TDATA;
  wire [0:0]addone_32x32_0_arg_0_TLAST;
  wire addone_32x32_0_arg_0_TREADY;
  wire addone_32x32_0_arg_0_TVALID;
  ...
  overlay_32x32_addone_32x32_0_0 addone_32x32_0
       (.ap_clk(zynq_ultra_ps_e_0_pl_clk0),
        .ap_rst_n(proc_sys_reset_0_peripheral_aresetn),
        .arg_0_TDATA(addone_32x32_0_arg_0_TDATA),
        .arg_0_TLAST(addone_32x32_0_arg_0_TLAST),
        .arg_0_TREADY(addone_32x32_0_arg_0_TREADY),
        .arg_0_TVALID(addone_32x32_0_arg_0_TVALID),
  ...
  overlay_32x32_axi_dma_0_0 axi_dma_0
       (.axi_resetn(proc_sys_reset_0_peripheral_aresetn),
        ...
        .s_axis_s2mm_tdata(addone_32x32_0_arg_0_TDATA),
        .s_axis_s2mm_tkeep({1'b1,1'b1,1'b1,1'b1}),
        .s_axis_s2mm_tlast(addone_32x32_0_arg_0_TLAST),
        .s_axis_s2mm_tready(addone_32x32_0_arg_0_TREADY),
        .s_axis_s2mm_tvalid(addone_32x32_0_arg_0_TVALID));
  overlay_32x32_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  overlay_32x32_smartconnect_0_0 smartconnect_0
  ...
  overlay_32x32_smartconnect_1_0 smartconnect_1
       (.M00_AXI_araddr(smartconnect_1_M00_AXI_ARADDR),
        ...
        .aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_interconnect_aresetn));
  overlay_32x32_xlconcat_0_0 xlconcat_0
       (.In0(axi_dma_0_mm2s_introut),
        .In1(axi_dma_0_s2mm_introut),
        .dout(xlconcat_0_dout));
  overlay_32x32_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
