...
//Date        : Tue Aug 18 21:21:39 2020
//Host        : charles-XPS-13-9370 running 64-bit Ubuntu 18.04.5 LTS
//Command     : generate_target overlay_8x16.bd
//Design      : overlay_8x16
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "overlay_8x16,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=overlay_8x16,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=9,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_zynq_ultra_ps_e_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "overlay_8x16.hwdef" *) 
module overlay_8x16
   ();

  wire [15:0]addone_8x16_0_arg_0_TDATA;
  wire [0:0]addone_8x16_0_arg_0_TLAST;
  wire addone_8x16_0_arg_0_TREADY;
  wire addone_8x16_0_arg_0_TVALID;
  ...
  overlay_8x16_addone_8x16_0_0 addone_8x16_0
       (.ap_clk(zynq_ultra_ps_e_0_pl_clk0),
        .ap_rst_n(proc_sys_reset_0_peripheral_aresetn),
        .arg_0_TDATA(addone_8x16_0_arg_0_TDATA),
        .arg_0_TLAST(addone_8x16_0_arg_0_TLAST),
        .arg_0_TREADY(addone_8x16_0_arg_0_TREADY),
        .arg_0_TVALID(addone_8x16_0_arg_0_TVALID),
        .arg_1_TDATA(axis_dwidth_converter_0_M_AXIS_TDATA),
        .arg_1_TLAST(axis_dwidth_converter_0_M_AXIS_TLAST),
        .arg_1_TREADY(axis_dwidth_converter_0_M_AXIS_TREADY),
        .arg_1_TVALID(axis_dwidth_converter_0_M_AXIS_TVALID));
  overlay_8x16_axi_dma_0_0 axi_dma_0
  ...
  overlay_8x16_axis_dwidth_converter_0_0 axis_dwidth_converter_0
  ...
  overlay_8x16_axis_dwidth_converter_1_0 axis_dwidth_converter_1
       (.aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn),
        ...
        .s_axis_tdata(addone_8x16_0_arg_0_TDATA),
        .s_axis_tlast(addone_8x16_0_arg_0_TLAST),
        .s_axis_tready(addone_8x16_0_arg_0_TREADY),
        .s_axis_tvalid(addone_8x16_0_arg_0_TVALID));
  overlay_8x16_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  overlay_8x16_smartconnect_0_0 smartconnect_0
  ...
  overlay_8x16_smartconnect_1_0 smartconnect_1
       (.M00_AXI_araddr(smartconnect_1_M00_AXI_ARADDR),
        ...
        .aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_interconnect_aresetn));
  overlay_8x16_xlconcat_0_0 xlconcat_0
       (.In0(axi_dma_0_mm2s_introut),
        .In1(axi_dma_0_s2mm_introut),
        .dout(xlconcat_0_dout));
  overlay_8x16_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
