...
architecture behav of Loop_2_proc21 is 
    ...
    signal trunc_ln51_fu_197_p1 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    add_ln36_1_fu_121_p2 <= std_logic_vector(unsigned(ap_const_lv9_1) + unsigned(p_hw_output_1_y_sca_reg_93));
    ...
    arg_0_TDATA_int <= std_logic_vector(unsigned(ap_const_lv16_1) + unsigned(trunc_ln51_fu_197_p1));
    ...
    p_hw_output_1_x_sca_fu_187_p2 <= std_logic_vector(unsigned(ap_const_lv9_1) + unsigned(select_ln55_fu_159_p3));
    ...
    trunc_ln51_fu_197_p1 <= p_in_1_stencil_stream_to_hw_output_1_V_value_V_dout(16 - 1 downto 0);
end behav;
