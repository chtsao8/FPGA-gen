...
architecture behav of hls_target is 
    ...
    signal Loop_1_proc20_U0_ap_start : STD_LOGIC;
    signal Loop_1_proc20_U0_ap_done : STD_LOGIC;
    signal Loop_1_proc20_U0_ap_continue : STD_LOGIC;
    signal Loop_1_proc20_U0_ap_idle : STD_LOGIC;
    signal Loop_1_proc20_U0_ap_ready : STD_LOGIC;
    signal Loop_1_proc20_U0_start_out : STD_LOGIC;
    signal Loop_1_proc20_U0_start_write : STD_LOGIC;
    signal Loop_1_proc20_U0_arg_1_TREADY : STD_LOGIC;
    signal Loop_1_proc20_U0_p_in_1_stencil_stream_to_hw_output_1_V_value_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Loop_1_proc20_U0_p_in_1_stencil_stream_to_hw_output_1_V_value_V_write : STD_LOGIC;
    signal Loop_1_proc20_U0_p_in_1_stencil_stream_to_hw_output_1_V_last_V_din : STD_LOGIC_VECTOR (0 downto 0);
    signal Loop_1_proc20_U0_p_in_1_stencil_stream_to_hw_output_1_V_last_V_write : STD_LOGIC;
    signal Loop_2_proc21_U0_ap_start : STD_LOGIC;
    signal Loop_2_proc21_U0_ap_done : STD_LOGIC;
    signal Loop_2_proc21_U0_ap_continue : STD_LOGIC;
    signal Loop_2_proc21_U0_ap_idle : STD_LOGIC;
    signal Loop_2_proc21_U0_ap_ready : STD_LOGIC;
    signal Loop_2_proc21_U0_p_in_1_stencil_stream_to_hw_output_1_V_value_V_read : STD_LOGIC;
    signal Loop_2_proc21_U0_p_in_1_stencil_stream_to_hw_output_1_V_last_V_read : STD_LOGIC;
    signal Loop_2_proc21_U0_arg_0_TDATA : STD_LOGIC_VECTOR (15 downto 0);
    signal Loop_2_proc21_U0_arg_0_TVALID : STD_LOGIC;
    signal Loop_2_proc21_U0_arg_0_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_sync_continue : STD_LOGIC;
    signal p_in_1_stencil_stream_2_full_n : STD_LOGIC;
    signal p_in_1_stencil_stream_2_dout : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal start_for_Loop_2_proc21_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Loop_2_proc21_U0_full_n : STD_LOGIC;
    signal start_for_Loop_2_proc21_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Loop_2_proc21_U0_empty_n : STD_LOGIC;
    signal Loop_2_proc21_U0_start_full_n : STD_LOGIC;
    signal Loop_2_proc21_U0_start_write : STD_LOGIC;

    component Loop_1_proc20 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
...
begin
    Loop_1_proc20_U0 : component Loop_1_proc20
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    Loop_2_proc21_U0 : component Loop_2_proc21
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    p_in_1_stencil_stream_2_U : component fifo_w32_d1_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    Loop_1_proc20_U0_ap_continue <= ap_const_logic_1;
    Loop_1_proc20_U0_ap_start <= ap_const_logic_1;
    Loop_2_proc21_U0_ap_continue <= ap_const_logic_1;
    Loop_2_proc21_U0_ap_start <= start_for_Loop_2_proc21_U0_empty_n;
    Loop_2_proc21_U0_start_full_n <= ap_const_logic_1;
    Loop_2_proc21_U0_start_write <= ap_const_logic_0;
    ...
    arg_0_TVALID <= Loop_2_proc21_U0_arg_0_TVALID;
    arg_1_TREADY <= Loop_1_proc20_U0_arg_1_TREADY;
    start_for_Loop_2_proc21_U0_din <= (0=>ap_const_logic_1, others=>'-');
end behav;
