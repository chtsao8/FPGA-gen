...
output   ap_idle;
output   ap_ready;
input  [7:0] p_in_1_stencil_stream_to_hw_output_1_V_value_V_dout;
...
wire   [0:0] icmp_ln54_fu_127_p2;
wire   [0:0] icmp_ln54_2_fu_153_p2;
wire   [8:0] select_ln54_fu_159_p3;
wire   [0:0] icmp_ln54_1_fu_175_p2;
wire   [0:0] select_ln54_1_fu_133_p3;
...
always @ (*) begin
    if ((((icmp_ln36_reg_218_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln36_reg_218 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln36_reg_218 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln36_reg_218 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln36_1_fu_121_p2 = (p_hw_output_1_y_sca_reg_93 + 9'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln36_reg_218 == 1'd0) & (io_acc_block_signal_op28 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state3_io) | ((icmp_ln36_reg_218 == 1'd0) & (io_acc_block_signal_op28 == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state3_io) | ((icmp_ln36_reg_218 == 1'd0) & (io_acc_block_signal_op28 == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state3_io = ((icmp_ln36_reg_218 == 1'd0) & (arg_0_TREADY_int == 1'b0));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((icmp_ln36_reg_218 == 1'd0) & (io_acc_block_signal_op28 == 1'b0));
end

always @ (*) begin
    ap_block_state4_io = ((icmp_ln36_reg_218_pp0_iter1_reg == 1'd0) & (arg_0_TREADY_int == 1'b0));
end
...
assign arg_0_TDATA_int = (p_in_1_stencil_stream_to_hw_output_1_V_value_V_dout + 8'd1);
...
assign icmp_ln54_1_fu_175_p2 = ((select_ln54_fu_159_p3 == 9'd255) ? 1'b1 : 1'b0);

assign icmp_ln54_2_fu_153_p2 = ((p_hw_output_1_y_sca_reg_93 == 9'd255) ? 1'b1 : 1'b0);

assign icmp_ln54_fu_127_p2 = ((add_ln36_1_fu_121_p2 == 9'd255) ? 1'b1 : 1'b0);
...
assign p_hw_output_1_x_sca_fu_187_p2 = (select_ln54_fu_159_p3 + 9'd1);

assign select_ln36_fu_167_p3 = ((icmp_ln38_fu_147_p2[0:0] === 1'b1) ? add_ln36_1_fu_121_p2 : p_hw_output_1_y_sca_reg_93);

assign select_ln54_1_fu_133_p3 = ((icmp_ln38_fu_147_p2[0:0] === 1'b1) ? icmp_ln54_fu_127_p2 : icmp_ln54_2_fu_153_p2);

assign select_ln54_fu_159_p3 = ((icmp_ln38_fu_147_p2[0:0] === 1'b1) ? 9'd0 : p_hw_output_1_x_sca_1_reg_104);

assign tmp_last_V_fu_181_p2 = (select_ln54_1_fu_133_p3 & icmp_ln54_1_fu_175_p2);
