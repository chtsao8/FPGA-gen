...
(* CORE_GENERATION_INFO="hls_target,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu7ev-ffvc1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.691000,HLS_SYN_LAT=65540,HLS_SYN_TPT=65540,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=96,HLS_SYN_LUT=485,HLS_VERSION=2020_1}" *)
...
wire   [15:0] Loop_1_proc16_U0_p_in_1_stencil_stream_to_hw_output_1_V_value_V_din;
...
fifo_w16_d1_S p_in_1_stencil_stream_2_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
