...
architecture behav of hls_target is 
    ...
    "hls_target,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu7ev-ffvc1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.854000,HLS_SYN_LAT=65540,HLS_SYN_TPT=65540,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=112,HLS_SYN_LUT=517,HLS_VERSION=2020_1}";
    ...
    signal Loop_1_proc16_U0_p_in_1_stencil_stream_to_hw_output_1_V_value_V_din : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal Loop_2_proc17_U0_arg_0_TDATA : STD_LOGIC_VECTOR (31 downto 0);
