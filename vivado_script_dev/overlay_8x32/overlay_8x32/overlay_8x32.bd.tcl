...
################################################################
# This is a generated script based on design: overlay_8x32
#
...
# source overlay_8x32_script.tcl
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
aha:halide_hardware:addone_8x32:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: addone_8x32_0, and set properties
  set addone_8x32_0 [ create_bd_cell -type ip -vlnv aha:halide_hardware:addone_8x32:1.0 addone_8x32_0 ]
  ...
  connect_bd_intf_net -intf_net addone_8x32_0_arg_0 [get_bd_intf_pins addone_8x32_0/arg_0] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axis_dwidth_converter_0_M_AXIS [get_bd_intf_pins addone_8x32_0/arg_1] [get_bd_intf_pins axis_dwidth_converter_0/M_AXIS]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins addone_8x32_0/ap_rst_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins addone_8x32_0/ap_clk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
