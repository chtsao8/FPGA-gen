...
HD_PWD='/home/charles/tmp/vivado_script_dev/overlay_8x32/overlay_8x32/overlay_8x32.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log overlay_8x32_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source overlay_8x32_wrapper.tcl
