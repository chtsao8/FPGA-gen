...
HD_PWD='/home/charles/tmp/vivado_script_dev/overlay_8x32/overlay_8x32/overlay_8x32.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log overlay_8x32_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source overlay_8x32_wrapper.tcl -notrace
